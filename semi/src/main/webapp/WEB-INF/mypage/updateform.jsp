				...
				<form action="insert" method="post" class="form-inline"
					...
					<table style="width: 600px;" class="mem">
						...
						<tr>
							...
							<td><input type="text" name="UserID" id="UserID"
								...
								<button type="button" class="btn btn-sm btn-danger" id="idcheck"
									style="width: 100px;">아이디체크</button> &nbsp; <br> <b
								class="idok"></b></td>
						</tr>
						<tr rowspan="2">
							...
							<br> <input type="password" id="password2"
								style="width: 300px;" class="form-control" required="required"
								placeholder="한번 더 입력"> &nbsp; <br> <b
								class="passok"></b></td>
						</tr>
						<tr>
							<th style="width: 130px;">핸드폰</th>
							<td><input type="text" name="hp" style="width: 300px;"
								class="form-control" required="required"></td>
						</tr>
						...
						<tr>
							...
							<td><input type="text" name="email1" style="width: 140px;"
								class="form-control" required="required"> <b>@</b> <input
								type="text" name="email2" id="email2" style="width: 140px;"
						...
						<tr rowspan="2">
							...
							<td><input type="text" id="address_search" name="address1"
								readonly style="width: 300px;" class="form-control"
							...
							<br> <input type="text" name="address2"
								style="width: 300px;" class="form-control
			   					required="
								required" placeholder="상세주소를 입력하세요"> &nbsp; <br></td>
						</tr>
